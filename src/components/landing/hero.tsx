        ...
        <div className="grid md:grid-cols-12 gap-8 items-center h-full">
          ...
          <div className="md:col-span-8 text-center">
            ...
            <div className="mt-10 flex flex-col sm:flex-row justify-center gap-4">
              <Button asChild size="lg" className="bg-gradient-to-r from-cyan-400 to-blue-500 text-primary-foreground hover:bg-cyan-400/90 active:scale-90 transition-transform duration-150">
                <Link href="#contact">
                  Get Started
                </Link>
              </Button>
