...
export default function About() {
  return (
    <section id="about" className="relative py-20 md:py-28 bg-background overflow-hidden">
      <div className="absolute top-1/2 left-0 h-1/2 w-2/5 -translate-y-1/2 bg-[radial-gradient(ellipse_at_center_left,_rgba(0,128,128,0.3),_transparent_70%)] -z-0"></div>
